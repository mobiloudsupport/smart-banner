(function(o,a){typeof exports=="object"&&typeof module<"u"?a(exports):typeof define=="function"&&define.amd?define(["exports"],a):(o=typeof globalThis<"u"?globalThis:o||self,a(o["ml-smart-banner"]={}))})(this,function(o){"use strict";var k=Object.defineProperty;var I=(o,a,u)=>a in o?k(o,a,{enumerable:!0,configurable:!0,writable:!0,value:u}):o[a]=u;var i=(o,a,u)=>(I(o,typeof a!="symbol"?a+"":a,u),u);const a=typeof window<"u",u={BANNER_CLOSED:new CustomEvent("BANNER_CLOSED",{bubbles:!0}),BANNER_MOUNTED:new CustomEvent("BANNER_MOUNTED"),BANNER_UNMOUNTED:new CustomEvent("BANNER_UNMOUNTED"),BANNER_LINK_CLICKED:new CustomEvent("BANNER_LINK_CLICKED",{bubbles:!0}),APPLE_NATIVE_BANNER_ACTIVE:new CustomEvent("APPLE_NATIVE_BANNER_ACTIVE")};function y(){var t=navigator.userAgent.toLowerCase()||navigator.vendor.toLowerCase()||window.opera;return/windows phone/i.test(t)?"windows":/android/i.test(t)?"android":/ipad|iphone|ipod/.test(t)&&!window.MSStream?"ios":"desktop"}const N=y(),_=!!navigator.userAgent.toLowerCase().match(/(ipad)|(iphone)|(ipod)|(android)|(webos)/i),A=navigator.userAgent.toLowerCase().includes("canvas");function B(){const t=navigator.userAgent;return/CriOS|Chrome/i.test(t)&&!/EdgiOS/i.test(t)?"chrome":/FxiOS|Firefox/i.test(t)?"firefox":/Safari/i.test(t)&&!/CriOS|FxiOS|OPiOS|EdgiOS|DuckDuckGo|Brave|Chrome|Firefox/i.test(t)?"safari":"other"}function S(){const t=navigator.userAgent,e=/iPhone|iPad|iPod/i.test(t),s=/Safari/i.test(t),l=!/CriOS|FxiOS|OPiOS|EdgiOS|DuckDuckGo|Brave|Chrome|Firefox/i.test(t);return e&&s&&l}const L=B(),T=S();class C{constructor(e){i(this,"button");i(this,"display","onLoad");i(this,"delay");i(this,"banner");i(this,"options");i(this,"heightStyleElement");i(this,"resizeListenerAttached",!1);i(this,"isCanvas",navigator.userAgent.toLowerCase().includes("canvas"));i(this,"os",y());i(this,"isMobile",navigator.userAgent.toLowerCase().match(/(ipad)|(iphone)|(ipod)|(android)|(webos)/i));i(this,"browser",B());i(this,"isIosSafari",S());i(this,"useSession");if(!a)return;const s=this;e=Object.assign({},{fontFamily:'"Source Sans Pro", "Arial", sans-serif',fallbackFontFamily:"sans-serif",appName:"ML",textColor:"#222",headingColor:"#222",buttonColor:"#222",buttonText:"Download",buttonTextColor:"#fff",iconUrl:"",textHeading:"Download now!",textDescription:"Try it now, download today",bannerColor:"#fff",linkIos:"https://itunes.apple.com/",linkAndroid:"https://play.google.com/",animation:"fadeIn",display:"onLoad",radius:"0",delay:0,shadow:!0,useSession:!0,zindex:999999,sessionExpire:1440},e);const f=`
  ...
  @keyframes slideRight {
    ...
    `;function g(n,m="white",r="black"){const d=document.createElement("canvas"),c=d.getContext("2d");return d.width=200,d.height=200,c.fillStyle=r,c.fillRect(0,0,d.width,d.height),c.font=`bold 100px ${e.fallbackFontFamily}`,c.fillStyle=m,c.textAlign="center",c.textBaseline="middle",c.fillText(n,d.width/2,d.height/2),d.toDataURL("image/png")}function x(n){const m=document.createElement("div");m.className="ml-smartBanner";const r=document.createElement("div");r.className="ml-smartBanner__wrapper";const d=document.createElement("img");d.className="ml-smartBanner__icon",d.src=n.iconUrl,d.onerror=function(){this.src=g(n.appName,n.buttonTextColor,n.buttonColor)};const c=document.createElement("div");c.className="ml-smartBanner__content";const E=document.createElement("h4");E.className="ml-smartBanner__title",E.innerHTML=n.textHeading,c.appendChild(E);const w=document.createElement("p");w.className="ml-smartBanner__description",w.innerHTML=n.textDescription,c.appendChild(w);const h=document.createElement("a");h.id="ml-smartBanner__button",h.className="ml-smartBanner__button",h.target="_blank",h.href=s.os==="android"?n.linkAndroid:n.linkIos,h.textContent=n.buttonText;const p=document.createElement("span");return p.id="ml-smartBanner__closebutton",p.className="ml-smartBanner__closebutton",p.textContent="×",h.onclick=function(){h.dispatchEvent(u.BANNER_LINK_CLICKED)},p.addEventListener("click",()=>{if(p.dispatchEvent(u.BANNER_CLOSED),s.unmount(),n.useSession){const D=new Date().getTime(),O=new Date(D+n.sessionExpire*60*1e3);window.localStorage.setItem("widgetClosed",O.toString())}}),r.appendChild(p),r.appendChild(d),r.appendChild(c),r.appendChild(h),m.appendChild(r),document.documentElement.appendChild(m),m}let b=x(e);this.addStyle(f),this.display=e.display,this.delay=e.delay,this.banner=b,this.useSession=e.useSession,this.options=e}updateBannerHeightStyle(){const e=this.banner.getBoundingClientRect().height;(!this.heightStyleElement||!this.heightStyleElement.isConnected)&&(this.heightStyleElement=document.createElement("style"),this.heightStyleElement.setAttribute("ml-smart-banner-height-style",""),document.head.appendChild(this.heightStyleElement)),this.heightStyleElement.textContent=`
      :root {
